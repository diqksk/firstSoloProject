	...
	<!-------------------------------------------aside----------------------------------------------->
		...
		<main style="float:left; padding:10px 10px 10px 0; margin:20px 0 0 0" >
			...
			<div>
				<table style="min-width: 870px;">
					<tbody>
						...
						<tr>
							<td colspan="4">
								<span id="id" style="font-size: 13px; margin:0 5px; font-weight:bold">${n.writer }</span>
								<span id="hit" style="font-size: 13px; margin:0 5px;">조회 <fmt:formatNumber type="number" pattern=",###" value="${n.hit }" /></span>
								<span id="date" style="font-size: 13px; margin:0 5px;"><fmt:formatDate pattern="yy-MM-dd hh:mm:ss" value="${n.regdate}" /></span>
							</td>
						</tr>
						<tr>
							<td colspan="4" style="padding:30px 0 60px 0 ">
								<p style="min-height: 200px;">
									${n.content }
									<input type="hidden" id="pagenum" value="${n.id }" />
								</p>
							</td>
						</tr>
						<tr>
			...
			<div class="margin-top">
				<table class="table border-top-default" style="text-align: left; min-width:1170px;">
					<tbody>
						<tr>
						...
						<tbody id="commentWrite">
							...
							<tr>
								...
								<td style="text-align: right;"><button type="button"
										onclick="writeFunction(); return false;"
										style="background-color: orange; color: white; border: 1px solid white">작성</button></td>
							</tr>
						</tbody>
					</table>
				</form>
...
<script defer type="text/javascript" src="/js/adminDetail.js">
</script>
</html>